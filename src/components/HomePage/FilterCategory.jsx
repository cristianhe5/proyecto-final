...
const FilterCategory = ({setCategorySlected}) => {
  ...
  return (
    <section className='category__filter'>
        ...
        <ul className='category__ul'>
            <li className='category__li' onClick={()=> handleCategory('all')}>All categories</li>
            {
                categories?.map( category => (
                    <li className='category__li' onClick={()=> handleCategory(category.id)} key={category.id}>{category.name}</li>
